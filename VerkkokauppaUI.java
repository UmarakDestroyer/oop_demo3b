...
public class VerkkokauppaUI {
    ...
    private void ostotapahtumaMenu() {
		...
		myyja.lisaaProvisio(0.1*ostos.getHinta());
		asiakas.lisaaOstos(ostos.getHinta());

            } else if (valinta == 2) {
	        System.out.println(Verkkokauppa.getTapahtumat());	
                int indeksi = lueKokonaisluku("Anna poistettava tapahtuma: ")-1;
		Ostotapahtuma tapahtuma = verkkokauppa.annaTapahtuma();
                if (tapahtuma==null) {
